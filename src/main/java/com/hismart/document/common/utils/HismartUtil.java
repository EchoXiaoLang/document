...
import com.hismart.document.common.function.CacheSelector;
...
public class HismartUtil {
    ...
    public static String encryptToken(String token) {
        try {
            EncryptUtil encryptUtil = new EncryptUtil(HismartConstant.TOKEN_CACHE_PREFIX);
