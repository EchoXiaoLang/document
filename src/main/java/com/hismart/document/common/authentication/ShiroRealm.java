...
import com.hismart.document.common.utils.HttpContextUtil;
...
public class ShiroRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        try {
            encryptTokenInRedis = redisService.get(HismartConstant.TOKEN_CACHE_PREFIX + encryptToken + "." + ip);
        ...
        // 通过用户名查询用户信息
        SinkUser user = userManager.getUser(username);
