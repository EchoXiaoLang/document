package com.hismart.document.common.aspect;
...
public class LogAspect {
    ...
    @Autowired
    private HismartProperties hismartProperties;

    @Autowired
    private LogService logService;

    @Pointcut("@annotation(com.hismart.document.common.annotation.Log)")
    ...
    public Object around(ProceedingJoinPoint point) throws JsonProcessingException {
        ...
        if (hismartProperties.isOpenAopLog()) {
            // 保存日志
